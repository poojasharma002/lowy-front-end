...
function chnageLookupTable(code, id){
    ...
    $('#cover-spin').show(0);
     $.ajax({
        url:origin+"/lowy-front-end/Categories/action",
        method:"POST",
        ...
        success:function(data){
          $('#cover-spin').hide(0); 
           ...
           $('#framePropertiesDetails tbody').append('<tr class="odd  selected">'+
                                    '<td class="first"><a href="'+origin+'/lowy-front-end/adminManageLookupablesView.action"></a></td>'+
                                    '<td class="last"><a href="'+origin+'/lowy-front-end/adminManageLookupablesView.action">Create New</a>'+
                                    '</td>'+
                                '</tr>');
